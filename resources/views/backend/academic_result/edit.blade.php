...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{-- <h4 class="m-0 text-dark">Academic Result Edit</h4> --}}
                </div>
                <div class="col-sm-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>
                        @lang('Academic Result') @lang('Edit')
                        <a class="btn btn-sm btn-success float-right" href="{{ route('setup.academic_result') }}"><i
                                class="fa fa-list"></i> @lang('Academic Result') @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form method="post" action="{{ route('setup.academic_result.update', $editData->id) }}" id="myForm"
                    ...
                    <div class="card-body">
                        <div class="form-group col-sm-12">
                            <div class="container">
                                <div class="radio_container" id="type" name="type">
                                    ...
                                    <label for="radio_faculty">In House</label>

                                    <input type="radio" onclick="radio_handle(2)" class="type_id" name="type_id"
                                        id="radio_dept" value="2" {{ @$editData->type_id == '2' ? 'checked' : '' }}>
                                    <label for="radio_dept">Affiliate Institute</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select id="department_id" 
                                    ...
                                    @foreach ($departments as $department)
                                        <option @if (!empty($editData) && $editData->department_id == $department->id) selected @endif
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select id="program_id" 
                                    ...
                                    @foreach ($programs as $program)
                                        <option @if (!empty($editData) && $editData->program_id == $program->id) selected @endif
                            ...
                            <div class="form-group col-sm-6">
                                <label>Upload New Attachment<small style="color: brown"> (Max 2 mb,Preferred file: pdf,doc,docx,xlsx)</small> <span class="text-red">*</span></label>
