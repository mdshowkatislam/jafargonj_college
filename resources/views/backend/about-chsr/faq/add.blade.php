...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">FAQ for ABOUT CHSR</h4>
        </div>
        <div class="col-sm-6">
...
<div class="container-fluid">
  <div class="col-md-12">
    <div class="card">
      ...
      <!-- Form Start-->
      <form method="post" action="{{(@$editData)?route('chsr.faq.update',$editData->id):route('chsr.faq.store')}}" id="myForm" enctype="multipart/form-data">
          @csrf
          ...
          <div class="card-body">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="hidden" name="faq_type" value="6">
