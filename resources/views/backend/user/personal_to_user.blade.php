            ...
            <div class="card">
                <div class="card-header">
                    <h5>
                        ...
                        <a class="btn btn-sm btn-success float-right"
                           href="{{ route('user') }}"><i class="fa fa-list"></i>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post"
                                  action="{{ route('personals_user.store') }}"
                                  id="myForm"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="control-label">@lang('Name') <span class="text-red">*</span>
                                        </label>
                                        <input type="text"
                                               name="name"
                                               id="name"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="control-label">@lang('Email') <span class="text-red">*</span>
                                        </label>
                                        <input type="email"
                                               name="email"
                                               id="email"
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="control-label">@lang('Mobile No') <span
                                                  class="text-red"></span></label>
                                        <input type="text"
                                               name="mobile"
                                               id="mobile"
                                    ...
                                    @if (!isset($editData))
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="control-label">@lang('Confirm') @lang('Password') <span
                                                      class="text-red">*</span> </label>
                                            <input type="password"
                                                   name="password2"
                                                   class="form-control form-control-sm">
                                    ...
                                    @endif
                                    <div class="form-group col-md-6">
                                        <label class="control-label">@lang('Role') <span
                                                  class="text-red">*</span></label>
                                        <select name="role_id"
                                                id="role_id"
                                                class="form-control form-control-sm">
