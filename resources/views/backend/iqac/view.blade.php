            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('IQAC')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="m-0 text-dark float-left"> @lang('List of IQAC')</h5>
                            {{-- <a href="{{ route('cpc.add') }}" class="btn btn-success float-right">Add CPC Service</a> --}}
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background: #00c5bf; color:#ffffff;">
                        <div class="inner">
                            <h5 style="height:60px;">IQAC Document</h5>
                        </div>
                        <div class="icon">
                            <i class="fa fa-file" style="font-size: 34px; top: 50%; transform: translateY(-50%);"></i>
                        </div>
                        <a href="{{ route('manage_document', 1) }}"
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box" style="background: #00c5bf; color:#ffffff;">
                        <div class="inner">
                            <h5 style="height:60px;">Image Gallery</h5>
                        </div>
                        <div class="icon">
                            <i class="fa fa-image" style="font-size: 34px; top: 50%; transform: translateY(-50%);"></i>
                        </div>
                        <a href="{{ route('setup.gallery_category.categoryWiseGallery', [7, $office->id]) }}"
                            class="small-box-footer">View <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
