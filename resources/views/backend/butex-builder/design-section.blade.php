    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Design Section</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        ...
        <form method="post" action="{{ route('store.design') }}">
          @csrf
          <div class="card card-outline card-primary">
            <div class="card-header">
              <div class="d-flex">
                <div class="flex-grow-1">
                  <h5 class="text-effect"><i class="nav-icon ion-settings"></i> Design {{ @$data->section_title }}</h5>
                </div>
                <div class="">
                  <button type="submit" role="button" class="btn btn-success" id="submitBtn">Update</button>
                  <a href="{{ url('site-settings/butex_builder', ['id' => $data->page_id, 'tab_id' => $data->page_tab_id]) }}">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                              <div class="p-3 mb-3 custom-shadow design-card rounded mb-2">
                                <div class="form-group">
                                  <label class="mt-2">Shadow (px)</label>  
                                  <div class="row">
                                    <div class="col-sm-3">
                            ...
                            <div class="col-sm-6">
                                  <div class="p-3 mb-2 custom-shadow rounded gradient-container" style="height: 410px;">
                            ...
                            <div class="col-sm-6">
                              <div class="p-3 mb-3 custom-shadow rounded" style="height: 410px;">
                                <div class="border-radius">
                                    <div class="controls">
                                      <label for="borderRadius">Border Radius: ( <span class="borderRadiusValue">0px</span>)</label>
                                      <input type="range" id="borderRadius" name="borderRadius" min="0" max="100" onchange="updateDesign()" value="{{ @$custom_style['borderRadius'] ?? 0 }}">
                                    </div>
                                </div>
 ...
 function updateDesign() {
     ...
     // const opacity       = document.getElementById('opacity').value;
      ...
      const classOutput  = document.getElementById('classOutput');
        ...
        bgOutput.style.opacity        = bg_opacity / 100;
        ...
        const cssPreview = `padding: ${paddingTop}px ${paddingRight}px ${paddingBottom}px ${paddingLeft}px; box-shadow: ${offset_x}px ${offset_y}px ${blur_radius}px ${shadow_color}; margin-top: ${marginTop}px; margin-right: ${marginRight}px; margin-bottom: ${marginBottom}px; margin-left: ${marginLeft}px; background: ${bg_color}; border-radius: ${border}; opacity: ${opacity}; border-top: ${border_top_width}px ${border_top_style} ${border_top_color}; border-right: ${border_right_width}px ${border_right_style} ${border_right_color}; border-bottom: ${border_bottom_width}px ${border_bottom_style} ${border_bottom_color}; border-left: ${border_left_width}px ${border_left_style} ${border_left_color};`;
