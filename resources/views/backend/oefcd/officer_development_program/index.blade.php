@extends('backend.layouts.app') @section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Staff Officer Development Program</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Staff Officer Development Program</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form
                        action="{{ route('officers_development_program.update', $data->id) }}"
                        method="post" enctype="multipart/form-data" autocomplete="off" id="myForm">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col-sm-12">
                                <label>Staff Officer Development Program <span class="text-red">*</span></label>
