    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <form id="myForm" method="post"  action="{{ !empty($editData) ? route('oefcd.staff.training_event.trainee_update', $editData->id) : route('oefcd.staff.training_event.trainee_store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-4">
                                <label class="control-label">Trainees <span class="text-red">*</span></label>
                                <select id="trainee_id" @if (!empty($editData))  @endif
                                    class="form-control form-control-sm select2" name="trainee_id">
                                    <option value="" selected>Please Select Trainer</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#myForm').validate({
            ...
            messages: {
                trainee_id: {
                    required: "Trainee Name is required."
                }
            },
            errorElement: 'span',
