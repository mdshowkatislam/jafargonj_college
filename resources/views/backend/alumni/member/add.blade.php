            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h5>
                        ...
                        @endif
                        <a class="btn btn-sm btn-info float-right" href="{{ route('alumni.member.list') }}"><i class="fa fa-list"></i> @lang('All Alumni Members') @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form id="myForm" method="post" action="{{ @$editData ? route('alumni.member.update', $editData->id) : route('alumni.member.store') }}" id="" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="alumniName">Student Name<span class="text-red">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="alumniName">Student ID <span class="text-red">*</span></label>
              ...
              <div class="form-group col-md-6">
                ...
                <input type="" name="join_date" class="form-control singledatepicker" value="{{@$editData->join_date}}">
                            ...
                            <div class="form-group col-md-6">
                                <img id="showImage" class="img-fluid shadow rounded" src="{{ !empty(@$editData->image) ? url('upload/alumni/member/image/' . @$editData->image) : url('upload/no_image.png') }}" style="width:50%;">
                                @if (@$editData->image)
                                <a class="btn btn-danger btn-sm delete mt-1" style="cursor: pointer" id="delete" title="Delete" data-route="{{ route('alumni.member.delete.photo') }}" data-id="{{ @$editData->id }}" data-token={{ csrf_token() }}><i class="fas fa-trash text-white"></i></a>
                                @endif
                            </div>
