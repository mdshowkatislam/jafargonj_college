...
@section('content')
 ...
 <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Jounal Section </h4>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('cpc.section', $id)}}" class="btn btn-success">Back</a>
                </div>
            </div>
        </div>
        <div class="col-md-12">
            <div class="card">
                <form method="post" action="{{!empty($editData->id) ? route('cpc.section.update', $editData->id) : route('cpc.section.store', $id)}}" id="myForm">
                    {{csrf_field()}}
                    <div class="card-body">
                            ...
                            <div class="form-row">
                              <input type="hidden" name="cpc_id" id="cpc_id" class="form-control form-control-sm" value="{{$id}}">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="sort_order" id="sort_order" class="form-control form-control-sm" value="{{@$editData->sort_order}}">
                                </div>
                            </div>
                            <div class="form-row">
