    ...
    <section class="content pb-3">
        <div class="container-fluid">
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <!-- Form Start-->
                    <form id="myForm" method="post" action="{{ !empty($editData->id) ? route('site-setting.contact.update', $editData->id) : route('site-setting.contact.store') }}" enctype="multipart/form-data">
                        @csrf
