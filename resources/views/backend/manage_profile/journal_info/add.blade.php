                        ...
                        <div class="col-11" style="border: 2px solid #e6e6b9;padding: 20px;border-radius: 10px 0px 0px 10px;">
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="text" name="JournalTitle[{{$key}}]" id="" class="form-control my-1" value="{{ !empty($profile_journal->JournalTitle)? $profile_journal->JournalTitle : "" }}" placeholder="Journal Title">
                                    <input type="text" name="DOI[{{$key}}]" id="" class="form-control my-1 @error('DOI') is-invalid @enderror" value="{{ !empty($profile_journal->DOI)? $profile_journal->DOI : "" }}" placeholder="https://doi.org/..........">
                                    @error('DOI')
                        ...
                        <div class="col-11" style="border: 2px solid #e6e6b9;padding: 20px;border-radius: 10px 0px 0px 10px;">
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="text" name="JournalTitle[5000]" id="" class="form-control my-1" placeholder="Journal Title">
                                    <input type="text" name="DOI[5000]" id="" class="form-control my-1 @error('DOI') is-invalid @enderror" placeholder="https://doi.org/..........">
                                    @error('DOI')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span> @enderror
        ...
        <div class="col-11" style="border: 2px solid #e6e6b9;padding: 20px;border-radius: 10px 0px 0px 10px;">
            <div class="row">
                <div class="form-group col-sm-12">
                    ...
                    <input type="text" name="JournalTitle[@{{counter}}]" id="" class="form-control my-1" placeholder="Journal Title">
                    <input type="text" name="DOI[@{{counter}}]" id="" class="form-control my-1 @error('DOI') is-invalid @enderror" placeholder="https://doi.org/..........">
                    @error('DOI')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span> @enderror
