                    ...
                    <div class="card-header">
                        <h5>@lang('Personnels to Faculty List')
                            <a class="btn btn-sm btn-primary float-right"
                                href="{{ route('manage_profile.personnels_to_faculty.add') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" title="Edit"
                                                href="{{ route('manage_profile.personnels_to_faculty.edit', @$profile['id']) }}"><i
                                            ...
                                            @if (@$profile->status == 1)
                                                <a role="button" type="button"
                                                    ...
                                                    data-route="{{ route('personnels_to_faculty.status_change') }}"
