                ...
                <div class="card-header">
                    <h5>
                        ...
                        <a class="btn btn-sm btn-success float-right"
                           href="{{ route('setup.program') }}"><i class="fa fa-list"></i> @lang('Program')
                            @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form method="post"
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="program_title">@lang('Program Title') <span class="text-red">*</span></label>
                                <input id="program_title"
                                       type="text"
                                       name="program_title"
                                       class="form-control @error('program_title') is-invalid @enderror"
                                       value="{{ @$editData->program_title }}"
                                       placeholder="">
                                @error('program_title')
                                    <span class="invalid-feedback"
                                          role="alert">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="outline"
                                          ...
                                          id=""
                                          cols="5"
                                          rows="5">{{ @$editData->outline }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="program_title">Admission Criteria</label>
                                <textarea name="admission_criteria"
                                          class="textarea"
                                          id=""
                                          cols="5"
                                          rows="5">{{ @$editData->admission_criteria }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="program_title">General Guidline</label>
                                <textarea name="general_guidline"
                                          class="textarea"
                                          id=""
                                          cols="5"
                                          rows="5">{{ @$editData->general_guidline }}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="program_title">Course List</label>
                                <textarea name="course_list"
                                          class="textarea"
                                          id=""
                                          cols="5"
                                          rows="5">{{ @$editData->course_list }}</textarea>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="is_admission"
                                        class="form-control"
                                        id="">
                                    <option value="">@lang('Please Select')</option>
                                    <option value="1"
                                            {{ @$editData->is_admission == 1 ? 'selected' : '' }}>ON
                                    </option>
                                    <option value="0"
                                            {{ @$editData->is_admission == 0 ? 'selected' : '' }}>OFF
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id=""
                                       ...
                                       class="form-control"
                                       value="{{ @$editData->admission_start_date }}"
                                       placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="">@lang('Admission End Date')</label>
                                <input id="ucam_program_id"
                                       type="date"
                                       name="admission_end_date"
                                       class="form-control"
                                       value="{{ @$editData->admission_end_date }}"
                                       placeholder="">
                            </div>
                            {{-- <div class="form-group col-md-6">
                                <label for="ucam_program_id">@lang('Ucam Program ID') <span class="text-red">*</span></label>
                                <input id="ucam_program_id"
                                       type="text"
                                       name="ucam_program_id"
                                       class="form-control"
                                       value="{{ @$editData->ucam_program_id }}"
                                       placeholder="">
                            </div> --}}
                            ...
                            <div class="form-group col-sm-3">
                                <img src="{{ asset('upload/program/' . @$editData['image']) }}"
                                     width="80"
                                     height="80">
                            </div>
                            <div class="form-group col-sm-3">
                                <label>Program-icon<small style="color: brown"> (Max 2 mb )</small></label>
                                <input type="file" id="image_icon"
                                       class="form-control filer_input_single @error('image_icon') is-invalid @enderror"
                                       name="image_icon"> @error('image_icon')
                                    <span class="invalid-feedback"
                                          role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-sm-3">
                                <img id="icon" src="{{ asset('upload/program_icon/' . @$editData['image_icon']) }}"
                                     width="80"
                                     height="80">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#myForm').validate({
                ...
                messages: {
                    program_category_id: {
                        required: "Program Category Id is required."
                    },
                    program_title: {
                        required: "Program Title ID is required."
                    },
                    department_id: {
                    ...
                    ucam_program_id: {
                        required: "UCAM Program Id is required.",
            ...
            $('#image_icon').change(function (e) { //show Image before upload
