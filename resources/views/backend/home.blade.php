...
@section('content')
<script src="{{asset('backend/js/amcharts4/core.js')}}"></script>
<script src="{{asset('backend/js/amcharts4/charts.js')}}"></script>
<script src="{{asset('backend/js/amcharts4/themes/kelly.js')}}"></script>
<script src="{{asset('backend/js/amcharts4/themes/animated.js')}}"></script>
  ...
  <section class="content">
    <div class="container-fluid">
      {{-- <div>
        ...
        <div>
          <img src="{{asset('images/default_logo.png')}}" alt="Admin Dashboard" class="" height="100px;" style="display: block;margin-left: auto;margin-right: auto;margin-bottom: 20px;">
        </div>
      ...
      <div class="row">
        ...
        {{-- <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              ...
              <img src="{{asset('images/dashboard_img/1_ptw.png')}}" alt="">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('images/dashboard_img/2_wtp.png')}}" alt="">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('images/dashboard_img/3_owt.png')}}" alt="">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('images/dashboard_img/5_dpl.jpg')}}" alt="">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('images/dashboard_img/4_tpl.jpg')}}" alt="">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body">
              <img src="{{asset('images/dashboard_img/6_wr.jpg')}}" alt="">
