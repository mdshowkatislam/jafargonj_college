...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Publication Status Edit</h4>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>
                        ...
                        @endif
                        <a class="btn btn-sm btn-success float-right" href="{{ route('news.publication_status') }}"><i
                                class="fa fa-list"></i> @lang('Publication Status') @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form method="post" action="{{ route('news.publication_status.update', $editData->id) }}" id="myForm" >
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
