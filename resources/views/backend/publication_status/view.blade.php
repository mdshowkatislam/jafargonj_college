            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h5>@lang('Publication Status') @lang('List')
                            ...
                            <a class="btn btn-sm btn-primary float-right" href="{{ route('news.publication_status.add') }}"
                                style="margin-right: 2px;"><i class="fa fa-plus-circle"></i> @lang('Publication Status')
                                @lang('Add')</a>
                        </h5>
                    </div>
                    <div class="card-body">
                        <table id="dataTable" class="table table-sm table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>@lang('SL')</th>
                                    <th>@lang('Publication Status Title')</th>
                                    <th>@lang('Status')</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($publicationStatus as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-primary" title="Edit"
                                                href="{{ route('news.publication_status.edit', $item->id) }}"><i
