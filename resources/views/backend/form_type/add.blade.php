            ...
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h5>
                        ...
                        @endif
                        <a class="btn btn-sm btn-info float-right" href="{{ route('setup.form_type') }}"><i
                                class="fa fa-list"></i> @lang('Form Type') @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form method="post" action="{{ route('setup.form_type.store') }}" id="myForm" >
                    @csrf
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-sm-6">
                                <label>Form Title <span class="text-red">*</span></label>
