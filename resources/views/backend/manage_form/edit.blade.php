...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Form Edit</h4>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-header">
                    <h5>
                        ...
                        <a class="btn btn-sm btn-success float-right"
                           href="{{ route('setup.manage_form') }}"><i class="fa fa-list"></i> @lang('Form')
                            @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                <form method="post"
                      action="{{ route('setup.manage_form.update', $editData->id) }}"
                      id="myForm"
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="pdf_file">@lang('PDF File')</label>
                                <input type="file"
                                       name="pdf_file"
                                ...
                                <select id="type_id"
                                    ...
                                    @foreach (@$formTypes as $formType)
                                        <option value="{{ $formType->id }}"
                                                {{ @$editData->type_id == $formType->id ? 'selected' : '' }}>
                                            {{ $formType->title }} </option>
                                    @endforeach
                                </select>
                                @error('type_id')
                                    <span class="invalid-feedback"
