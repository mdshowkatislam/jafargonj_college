...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h5>
                        ...
                        @endif
                        <a class="btn btn-sm btn-info float-right" href="{{ route('setup.manage_department') }}"><i
                                class="fa fa-list"></i> @lang('Subject')
                            @lang('List')</a>
                    </h5>
                </div>
                <!-- Form Start-->
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 @if (isset($admin_faculty_id)) d-none @endif">
                                ...
                                @php
                                    ...
                                    $faculties = $allFaculties->prepend(
                                        (object) ['id' => 0, 'name' => 'Common Department'],
                                    );
                                    //    $faculties = collect([(object)['id'=>111,'name'=>'Common Department']]);
                                    //  dd($faculties);
                                @endphp
          ...
          `                          <option value="">@lang('Please Select')</option>
                                ...
                                @if ((!empty($editData) && $isFacultyHead) || $isDepartmentHead)
                                    <input type="hidden" name="faculty_id" id=""
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="" class="form-control form-control-sm select2" name="profile_id"
                                    @if ($isDepartmentHead) disabled @endif>
                                ...
                                @if (!empty($editData) && $isDepartmentHead)
                                    <input type="hidden" name="profile_id" id=""
    ...
    @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="slider_id" class="form-control form-control-sm select2" name="top_menu">
                                    <option selected value="">Select Top Menu Bar</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="slider_id" class="form-control form-control-sm select2" name="nav_menu">
                                    <option selected value="">Select menu bar</option>
                                    {{-- <option value="1">Slider 1</option>
                                 <option value="2">Slider 2</option> --}}
                                    @foreach ($menu_types as $item)
                            ...
                            @endphp
                            <div class="form-group col-md-6">
                                <label class="control-label">Slider <span class="text-danger">(Home page slider for this
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label">Banner <span class="text-danger">(Inner page banner for this
                                        department)</span></label>
                                <select id="banner_id" class="form-control form-control-sm select2" name="banner_id">
                                    <option selected value="">Select banner</option>
                            ...
                            <div class="form-group col-md-6">
                                <label class="control-label">Instaled Themes <span><a target="_blank"
                                            href="{{ url('site-settings/butex_themes/3/' . @$page_id) }}">Go to
                                            Themes</a></span></label>
                                <select id="themes" class="form-control form-control-sm select2" name="themes"
                                    disabled>
