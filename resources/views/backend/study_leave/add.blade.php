...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-outline card-info">
            ...
            <div class="card-body">
                <form id="myForm" action="{{ route('manage_leave.store') }} " method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <select id="profile_id" name="profile_id" class="form-control select2 is-invalid">
