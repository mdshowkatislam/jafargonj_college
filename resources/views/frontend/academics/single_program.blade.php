                    ...
                    <div class="mb-3 program-type">
                        ...
                        <form class="filter-form">
                            ...
                            <div class="shadow pb-3 mb-5 rounded program-type ">
                                ...
                                @php
                                    $fall = App\Models\Program::where('program_category_id', request()->id)->where('status', 1)->count('faculty_id');
                                @endphp
                                ...
                                @foreach ($faculties as $key => $f)
                                    ...
                                    @php
                                        $dall = App\Models\Program::where('program_category_id', request()->id)->where('status', 1)->count('department_id');
                                    @endphp
                                    <script>
                            ...
                            <div id="department_div" class="shadow pb-3 mb-5 rounded">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        for (let i = 0; i < data.length; i++) {
                            ...
                            html += `<div class="academics-card mb-4 rounded col-lg-4 col-md-6">
                        <div class="academics-card-icon text-center p-3 bg-light shadow rounded">
                            <a href="../academics/academic_details/${data[i]['id']}">
                                
                                <p class="fs-6 text-center mt-2">${data[i]['program_title']}</p>
                            </a>
                        </div>
                    </div>`
                        }
