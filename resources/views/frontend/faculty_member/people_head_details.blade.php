...
<style>
    ...
    .faculty-social-icon {
        width: 30px;
        height: 30px;
        background-color: #b61e2b !important;
        margin: 0 5px;
    }
    .faculty-contact h1 {
        font-size: 14px;
    ...
    .text-common-color, .text-primary {
        color: #00c5bf !important;
    }
    .nav-link {
                ...
                <div class="shadow-sm p-3 mb-3 bg-light rounded">
                    ...
                    <div class="faculty-contact">
                        <h1 class="d-flex justify-content-start align-items-center"><i
                                class="bi bi-envelope-at fs-3 mx-2" style="color: #00c5bf;"></i>{{ $profile->profile->email }}
                        </h1>
                        <hr>
                        <h1 class="d-flex justify-content-start align-items-center"><i
                                class="bi bi-geo-alt fs-3 mx-2" style="color: #00c5bf;"></i>
                                92 Shaheed Tajuddin Ahmed Avenue
                                Tejgaon Industrial Area,
                                Dhaka - 1208, Bangladesh</h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-9">
                ...
                <div class="tab-content shadow-sm px-3 pb-3 mb-5 bg-light rounded" id="myTabContent">
                    <div class="tab-pane fade show active profile-details-tab-content" id="one-tab-pane" role="tabpanel"
                        ...
                        @if (count($biographys) > 0)
                            <div class="pt-3 border-bottom">
                                ...
                                <div class="content p-3 text-justify">
                                    @foreach ($biographys as $biography)
                                        {!! @$biography->Biography !!}
                                        {{-- <div class="pt-3">
                                            <p class="text-right text-common-color fs-7 m-0">Last Updated:
                        ...
                        @if (count($edu) > 0)
                            <div class="pt-3 border-bottom">
                                ...
                                {{-- <div class="pt-3">
                                    <p class="text-right text-common-color fs-7 mb-3">Last Updated:
                            ...
                            <div class="pt-3 border-bottom">
                                ...
                                <div class="content p-3">
                                    @foreach ($conferences as  $index=>$conference)
                                        <p class="mb-3"><span>{{ $index+1 }}. </span>{!! @$conference->ConferenceDetail !!}</p>
                                    @endforeach
                                        {{-- <div class="pt-3">
                                            <p class="text-right text-common-color fs-7 m-0">Last Updated:
                        ...
                        @if (count($books) > 0)
                            <div class="pt-3 border-bottom">
                                ...
                                <div class="content p-3">
                                    ...
                                    <p class="mb-3"><span>{{ $index+1 }}. </span>{!! @$book->BookDetail !!}</p>
                                        {{-- <div class="pt-3">
                                            <p class="text-right text-common-color fs-7 m-0">Last Updated:
                            ...
                            <div class="pt-3 border-bottom">
                                ...
                                <div class="content p-3">
                                    @foreach ($researchs as $index => $research)
                                        <p class=""><span>{{ $index+1 }}. </span>{!! @$research->ResearchAreasOrInterest !!}</p>
                                    @endforeach
                                        {{-- <div class="pt-3">
                                            <p class="text-right text-common-color fs-7 m-0">Last Updated:
                        ...
                        @if (count($awards) > 0)
                            <div class="pt-3 border-bottom">
                                ...
                                <div class="content p-3">
                                    ...
                                    <p class=""><span>{{ $index+1 }}. </span>{!! @$award->AwardHonor !!}</p>
                                    @endforeach
                                        {{-- <div class="pt-3">
                                            <p class="text-right text-common-color fs-7 m-0">Last Updated:
                        ...
                        @if (count($courses) > 0)
                            <div class="pt-3 border-bottom">
                                ...
                                <div class="content p-3">
                                    ...
                                    <p class=""><span>{{ $index+1 }}. </span>{!! @$course->CourseTaught !!}</p>
                                    @endforeach
                                        {{-- <div class="pt-3">
                                            <p class="text-right text-common-color fs-7 m-0">Last Updated:
                    ...
                    <div class="tab-pane fade profile-details-tab-content pt-3" id="two-tab-pane" role="tabpanel"
                        ...
                        {{-- <div class="pt-3">
                            <p class="text-right text-common-color fs-7">Last Updated:
                                {{ date('d M Y', strtotime(@$profile->updated_at)) }}</p>
                        </div> --}}
                    </div>
