...
@section('content')
    ...
    @include('frontend.partials.sections.banner-with-title', ['page_title' => 'Journal'])
                    ...
                    <div class="courses-info">
                            ...
                            <div class="tab-content tab-content-info">
                                <div id="tab1"
                                    ...
                                    <div class="info title text-justify colored-link">
                                       @if(!empty($info->attachment1))
                                        <img style="height: 280px; width: 100%;" src="{{ asset('/upload/journal/'.@$info->attachment1) }}"  alt="">
                                       @else
                        ...
                        <div class="container">
                            ...
                            @if($researchFiles->isEmpty())
                                <p>No files found for this journal.</p>
                            @else
                        ...
                        <div class="author-items">
                            ...
                            <div class="item">
                                <div class=" text-justify">
                                    <h5 class="fs-6">
                                         <a href="{{ route('research.details2',$item->id) }}"
                                           >
                                           {{  $item->paper_title}}
                                        </a>
                                    </h5>
                            ...
                            <a href="/media_and_publication">View All <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
