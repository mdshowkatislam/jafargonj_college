        ...
        <div class="container my-5">
            <div class="row rounded" style="height:11rem; background-color: #f1f1f1">
                ...
                <div class="col-md-8 my-auto justify-content-center">
                    <form action="{{ route('department_departmentNewsEventNoticeFilter', $department->id) }}" method="post" enctype="multipart/form-data" autocomplete="off" id="myForm">
                        @csrf
            ...
            <div class="container">
                <div class="row">
                    ...
                    @else
                        <div class="mt-5 col-12 border-bottom pb-5">
                            <div class="row d-flex justify-content-center">
                                <h1 class="fs-4 fw-bold mb-2">There are no {{$page_title}} at this moment!</h1>
                            </div>
                        </div>
                    @endif
                </div>
