...
@php
    $page_title = 'Brochure & Newsletter';
@endphp
@section('title')
    {{ $page_title }}
@endsection
            ...
            <div class="academic-details mb-5">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-8" id="newsletter-list">
                            <div class="row">
                                @foreach ($infos as $key => $info)
                                    <div class="col-lg-12 mb-4">
                                        <div class="bg-light shadow p-3 rounded" style="">
                                            ...
                                            <a href="{{ asset('upload/newsletter/'.$info->attachment) }}"
...
@section('script')
    <script>
        $(document).on('click', '.year', function() {
            ...
            $.ajax({
                url: "{{ route('newsletter_by_year') }}",
                type: "GET",
                data: {
                    year: year
                },
                success: function(data) {
                    $('#newsletter-list').html(data);
                }
            });
        });
    </script>
