@php
$logoFooterCenter = DB::table('banners')->where('ref_id', '3333')->where('status', 1)->first();
@endphp
...
<style>
    ...
    .background-container{
        position: relative; 
        background-image: url("{{ asset('upload/banner/' . $logoFooterCenter->image) }}");
...
<footer class="text-light background-container" style="{{ @$design->css_preview_top }}">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xl-3 col-md-6 item equal-height">
                    <div class="f-item link" data-aos="" data-aos-duration="3000" style="line-height:18px">
                        ...
                        <ul>
                            @php $position_id = DB::table('menu_types')->where('position','conference_footer_1')->pluck('id')->first();
                            $footer1 = DB::table('frontend_menus')->where('status',1)->where('parent_id','0')->where('menu_type_id',$position_id)->orderBy('sort_order','asc')->take(6)->get();
                            @endphp
                ...
                <div class="col-sm-6 col-xl-3 col-md-6 item equal-height">
                    <div class="f-item link" data-aos="" data-aos-duration="3000" style="line-height:18px">
                        ...
                        <ul>
                            @php
                            $position_id2 = DB::table('menu_types')->where('position','conference_footer_2')->pluck('id')->first();
                            $footer2 = DB::table('frontend_menus')->where('status',1)->where('parent_id','0')->where('menu_type_id',$position_id2)->orderBy('sort_order','asc')->take(6)->get();
                            @endphp
                ...
                <div class="col-sm-6 col-xl-3 col-md-6 item equal-height">
                    <div class="f-item link" data-aos="" data-aos-duration="3000" style="line-height:18px">
                        ...
                        <ul>
                            @php
                            $position_id3 = DB::table('menu_types')->where('position','conference_footer_3')->pluck('id')->first();
                            $footer3 = DB::table('frontend_menus')->where('status',1)->where('parent_id','0')->where('menu_type_id',$position_id3)->orderBy('sort_order','asc')->take(6)->get();
                            @endphp
                ...
                <div class="col-sm-6 col-xl-3 col-md-6 item footer-margin">
                    <div class="">
                    @php
                    $logoFooterRightLeft  = DB::table('logos')->where('type_id',4)->first();
                    $logoFooterRightRight = DB::table('logos')->where('type_id',5)->first();
                    ...
                    @endphp
                        ...
                        <div class="footer-content urgent-need" data-aos="" data-aos-duration="3000">
                            <p class="custom-font-titillium-web" style="font-size:13px;">
                                ...
                                <span style="font-size: 15px;">Bangladesh University of Textiles</span> <br/>
    ...
    <div class="py-2 align-items-center" style="{{ @$design->css_preview_bottom }}">
        <div class="container" style="{{ @$json_style['bottom_text_color'] }}">
            <div class="row">
                <div class="col-sm-6">
                    <p class="mb-0 fs-7 custom-font-titillium-web">All Rights Reserved © Bangladesh University of Textiles, 2024</p>
                </div>
