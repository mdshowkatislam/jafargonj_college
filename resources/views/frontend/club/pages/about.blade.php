{{-- resources/views/frontend/club/pages/about.blade.php --}}
                    ...
                    <div class="bg-light p-3 rounded shadow  about-message-content d-flex justify-content-center"
                        ...
                        <div>
                            ...
                            <div class="text-justify fs-6">
                                ...
                                @endphp
                                {!! Str::limit(@$club->description, 800, '...') !!}
                                @if (!$textLeft)
                                    <a href="{{ route('club.message', @$club->id) }}" class="ms-1 fw-bold common-font-color">Read More </a>
                                @endif
                            </div>
