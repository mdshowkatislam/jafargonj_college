...
<div class="header">
    <div class="fixed-top">
        <!-- Top Bar -->
        <section id="topbar" class="d-flex justify-content-center align-items-center d-none d-md-block" style="background: #00c5bf !important">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-sm-center">
                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark" href="{{ route('index') }}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark {{ request()->routeIs('club.index') ? 'active' : '' }}" href="{{ route('club.index', @$club->slug) }}">Club Home</a>
                        </li>
                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark {{ request()->routeIs('club.about') ? 'active' : '' }}" href="{{ route('club.about', $club->slug) }}">About</a>
                        </li>
                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark {{ request()->routeIs('club.committee') ? 'active' : '' }}" href="{{ route('club.committee', $club->slug) }}">Committee</a>
                        </li>
                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark {{ request()->routeIs('club.member') ? 'active' : '' }}" href="{{ route('club.member', $club->slug) }}">Member</a>
                        </li>

                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark {{ request()->routeIs('club.activities') ? 'active' : '' }}" href="{{ route('club.activities', $club->slug) }}">Activities</a>
                        </li>
                        <li class="nav-item">
                            <a style="font-weight: bold; font-size: 14px;" class="nav-link text-dark {{ request()->routeIs('club.gallery') ? 'active' : '' }}" href="{{ route('club.gallery', $club->slug) }}">Gallery</a>
                        </li>
                        {{-- <li class="nav-item">
