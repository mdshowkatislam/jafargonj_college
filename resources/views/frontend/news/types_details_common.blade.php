...
<div class="breadcrumb-area shadow dark text-center text-light"
    style="background-image: url(http://localhost/butex-website/upload/banner/banner-butex.png); background-repeat: no-repeat; padding-top:190px;">
    <div class="container">
        <div class="row">
...
<div class="course-details-area default-padding">
    <div class="container">
        <div class="row">
           ...
           @include('frontend.partials.side-latest-new-common')
        </div>
    </div>
</div>
@endsection
