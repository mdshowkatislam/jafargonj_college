    ...
    <nav class="navbar navbar-expand-lg" id="main-menu">
      <div class="container">
        ...
        <a class="navbar-brand d-flex align-items-center" href="{{ route('faculty_home', $faculty->id) }}">
          <span class="text-secondary text-uppercase fs-6 fw-bold mb-0 d-none d-sm-block">{{$faculty_name}}</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-sm-center">
            ...
            <li class=" nav-item">
              <a class="nav-link text-uppercase" href="{{ route('faculty_notice', $faculty->id) }}">Notice</a>
            ...
            <li class="nav-item">
              <a class="nav-link text-uppercase" href="{{ route('faculty_dean_honour_board', $faculty->id) }}">Dean's Honour Board</a>
            </li>
            {{-- <li class="nav-item">
