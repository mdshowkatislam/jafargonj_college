<style>
    .business-banner-card {
        background-image: linear-gradient(rgba(237, 28, 36, 0.4),
                rgba(237, 28, 36, 0.8)),
            url({{ asset('frontend/assets/img/butex/banner-butex.png') }});
    }
...
@section('content')
    ...
    @foreach (@$sections as $key => $section)
        ...
        <section class="{{ @$section_layout }}" data-aos="{{ @$section_fade }}"
            style="{{ @$cssPreview }} {{ @$section->custom_css }}">
            <div class="row">
                @if (!empty(@$section->col1_name))
                    <div class="{{ @$col_1 }}">
                        @php
                            $component = App\Models\CmsComponent::where('section_id', @$section->rand_id)
                                ->where('column_id', '1')
                                ->latest()
                                ->first();
                        ...
                        <div class="{{ @$json_class1['layout'] }}" data-aos="{{ @$json_class1['fade'] }}"
                            style="{{ @$component->cssPreview }} {{ @$component->custom_css }}">
                            @if ($component_type == '0')
                                <div>
                                    ...
                                    @if (!empty($component->files) && file_exists(public_path('upload/themes/' . $component->files)))
                                        ...
                                        <div class="{{ @$component->image_class }}">
                                            <img src="{{ asset('upload/themes/' . $component->files) }}"
                                                class="image-{{ $component->id }}" alt="Butex">
                                        </div>
                                    @endif
                                </div>
                            @elseif($component_type == '1')
                                @php
                                    $formTemplate = App\Models\FormTemplate::where('id', @$component_id)
                                        ->where('status', 'active')
                                        ->first();
                ...
                @if (!empty(@$section->col2_name))
                    <div class="{{ @$col_2 }}">
                        @php
                            $component2 = App\Models\CmsComponent::where('section_id', @$section->rand_id)
                                ->where('column_id', '2')
                                ->latest()
                                ->first();
                        ...
                        <div class="{{ @$json_class2['layout'] }}" data-aos="{{ @$json_class2['fade'] }}"
                            style="{{ @$component2->cssPreview }} {{ @$component2->custom_css }}">
                            @if ($component_type == '0')
                                <div>
                                    ...
                                    @if (!empty($component2->files) && file_exists(public_path('upload/themes/' . $component2->files)))
                                        ...
                                        <div class="{{ @$component2->image_class }}">
                                            <img src="{{ asset('upload/themes/' . $component2->files) }}"
                                                class="image-{{ $component2->id }}" alt="Butex">
                                        </div>
                                    @endif
                                </div>
                            @elseif($component_type == '1')
                ...
                @if (!empty(@$section->col3_name))
                    <div class="{{ @$col_3 }}">
                        @php
                            $component3 = App\Models\CmsComponent::where('section_id', @$section->rand_id)
                                ->where('column_id', '3')
                                ->latest()
                                ->first();
                        ...
                        <div class="{{ @$json_class3['layout'] }}" data-aos="{{ @$json_class3['fade'] }}"
                            style="{{ @$component3->cssPreview }} {{ @$component3->custom_css }}">
                            @if ($component_type == '0')
                                <div>
                                    ...
                                    @if (!empty($component3->files) && file_exists(public_path('upload/themes/' . $component3->files)))
                                        ...
                                        <div class="{{ @$component3->image_class }}">
                                            <img src="{{ asset('upload/themes/' . $component3->files) }}"
                                                class="image-{{ $component3->id }}" alt="Butex">
                                        </div>
                                    @endif
                                </div>
                            @elseif($component_type == '1')
                ...
                @if (!empty(@$section->col4_name))
                    <div class="{{ @$col_4 }}">
                        @php
                            $component4 = App\Models\CmsComponent::where('section_id', @$section->rand_id)
                                ->where('column_id', '4')
                                ->latest()
                                ->first();
                        ...
                        @endphp
                        <div class="{{ @$json_class4['layout'] }}" data-aos="{{ @$json_class4['fade'] }}"
                            style="{{ @$component4->cssPreview }} {{ @$component4->custom_css }}">
                            @if ($component_type == '0')
                                <div>
                                    ...
                                    @if (!empty($component4->files) && file_exists(public_path('upload/themes/' . $component4->files)))
                                        ...
                                        <div class="{{ @$component4->image_class }}">
                                            <img src="{{ asset('upload/themes/' . $component4->files) }}"
                                                class="image-{{ $component4->id }}" alt="Butex">
                                        </div>
                                    @endif
                                </div>
                            @elseif($component_type == '1')
                ...
                @if (!empty(@$section->col5_name))
                    <div class="{{ @$col_5 }}">
                        @php
                            $component5 = App\Models\CmsComponent::where('section_id', @$section->rand_id)
                                ->where('column_id', '5')
                                ->latest()
                                ->first();
                        ...
                        <div class="{{ @$json_class5['layout'] }}" data-aos="{{ @$json_class5['fade'] }}"
                            style="{{ @$component5->cssPreview }} {{ @$component5->custom_css }}">
                            @if ($component_type == '0')
                                <div>
                                    ...
                                    @if (!empty($component5->files) && file_exists(public_path('upload/themes/' . $component5->files)))
                                        ...
                                        <div class="{{ @$component5->image_class }}">
                                            <img src="{{ asset('upload/themes/' . $component5->files) }}"
                                                class="image-{{ $component5->id }}" alt="Butex">
                                        </div>
                                    @endif
                                </div>
                            @elseif($component_type == '1')
                ...
                @if (!empty(@$section->col6_name))
                    <div class="{{ @$col_6 }}">
                        @php
                            $component6 = App\Models\CmsComponent::where('section_id', @$section->rand_id)
                                ->where('column_id', '6')
                                ->latest()
                                ->first();
                        ...
                        <div class="{{ @$json_class6['layout'] }}" data-aos="{{ @$json_class6['fade'] }}"
                            style="{{ @$component6->cssPreview }} {{ @$component6->custom_css }}">
                            @if ($component_type == '0')
                                <div>
                                    ...
                                    @if (!empty($component6->files) && file_exists(public_path('upload/themes/' . $component6->files)))
                                        ...
                                        <div class="{{ @$component6->image_class }}">
                                            <img src="{{ asset('upload/themes/' . $component6->files) }}"
                                                class="image-{{ $component6->id }}" alt="Butex">
                                        </div>
                                    @endif
                                </div>
                            @elseif($component_type == '1')
