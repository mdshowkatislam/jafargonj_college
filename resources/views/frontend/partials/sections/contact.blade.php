...
@php
    $page_title = 'Jafargonj Mir Abdul Gafur Degree College Location';
@endphp
@section('title')
    {{ $page_title }}
@endsection
...
<style>
  .circle {
    ...
    background-color: #1BCC7A; /* Change this to your desired color */
    ...
    <div class="container overview">
        ...
        <div class="row mt-4">
            <div class="col-md-12 animate__animated animate__fadeInRight" style="animation-delay: 0.4s; opacity: 1;">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d384.3824711303139!2d91.05419470431018!3d23.572646777321676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37546ffed6ec1089%3A0x5f61560e28eee17c!2sJafargonj%20Mir%20Abdul%20Gafur%20College!5e0!3m2!1sen!2sbd!4v1751450293603!5m2!1sen!2sbd" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
