            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="top-author">
                        <h4 class="text-uppercase text-center fs-4 p-3 w-100 fw-bold" style="background-color: rgb(205, 199, 199)">Research</h4>
                        <div class="author-items">
                            ...
                            <a class="float-end border p-2" href="{{ route('research_list') }}">View All <i class="fas fa-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
